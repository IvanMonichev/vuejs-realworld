...
export const mutationTypes = {
  updateArticleStart: '[update-article] Update article start',
  updateArticleSuccess: '[update-article] Update article success',
  updateArticleFailure: '[update-article] Update article failure',

  getArticleStart: '[get-article] Get article start',
  getArticleSuccess: '[get-article] Get article success',
  getArticleFailure: '[get-article] Get article failure',
}
